...
#define X86_64_IDT_IPI_REMOTE_NOOP 0xf8
#define X86_64_IDT_IPI_REMOTE_LEAVE_PMAP 0xf9
#define X86_64_IDT_IPI_REMOTE_TLB 0xfa
#define X86_64_IDT_IPI_REMOTE_PREEMPT 0xfb
#define X86_64_IDT_IPI_REMOTE_HALT 0xfc
