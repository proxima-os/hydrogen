...
#define SYSCALL0(num) ({ asm volatile("syscall" : "=a"(ret), "=d"(error) : "a"(num) : "rcx", "r11", "memory"); })

#define SYSCALL1(num, a0)                                                                                              \
    ({ asm volatile("syscall" : "=a"(ret), "=d"(error) : "a"(num), "D"(a0) : "rcx", "r11", "memory"); })

#define SYSCALL2(num, a0, a1)                                                                                          \
    ({ asm volatile("syscall" : "=a"(ret), "=d"(error) : "a"(num), "D"(a0), "S"(a1) : "rcx", "r11", "memory"); })
