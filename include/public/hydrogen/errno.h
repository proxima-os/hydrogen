...
#define ENOEXEC 45         /* Invalid executable format */
#define ENOLCK 46          /* No locks available */
#define ENOLINK 47         /* Reserved */
#define ENOMEM 48          /* Out of memory */
...
#define ENOSYS 52          /* Not implemented */
...
#define ENOTTY 59          /* Inappropriate ioctl */
#define ENXIO 60           /* No such device or address */
/* Hydrogen does not define EOPNOTSUPP; libc should alias it to ENOTSUP */
...
#define EXDEV 77           /* Improper hard link */
